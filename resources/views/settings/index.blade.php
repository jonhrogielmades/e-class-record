...
@section('header_meta')
    @if ($user->isTeacher())
        ...
        <span class="status-pill">{{ $user->department ?: 'BSIT Program' }}</span>
        ...
        <section class="profile-grid">
            <article class="glass-card profile-summary-card">
                ...
                <ul class="detail-list">
                    <li><strong>Department:</strong> {{ $user->department ?: 'BSIT Program' }}</li>
            ...
            <article class="glass-card">
                ...
                <form method="POST" action="{{ route('settings.update') }}" class="form-grid">
                    ...
                    <div class="form-group-settings"><label for="settings-department">Department</label><input id="settings-department" class="form-input" type="text" name="department" value="{{ old('department', $user->department ?: 'BSIT Program') }}"></div>
